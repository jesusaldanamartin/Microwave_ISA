...
public class ClosedWithItem extends Microwave {
	...
	@Override
	public void cooking_stop(){ throw new MicrowaveExceptions("Todavía no ha comenzado el microondas ha cocinar"); };
	public void tick(){ throw new MicrowaveExceptions("Todavía no ha comenzado el microondas ha cocinar"); };
